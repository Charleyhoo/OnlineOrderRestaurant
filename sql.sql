...
CREATE TABLE `food` (
  ...
  `picture` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'url of picture',
...
insert  into `food`(`name`,`price`,`availability`,`ingredients`,`picture`,`calorie`,`type`,`id`,`restaurant`) values ('Apple',39,0,'Apple 100%','https://tse1-mm.cn.bing.net/th/id/OIP-C.yB6BAfNWrimtDWxEqNhuigHaIE?w=160&h=180&c=7&r=0&o=5&dpr=1.6&pid=1.7',43,'Fruit',2,2),('Pear',41,0,'Pear 100%','https://tse1-mm.cn.bing.net/th/id/OIP-C.5reEZ0JJ2MQNos0tLB3zNwHaIc?w=170&h=193&c=7&r=0&o=5&dpr=1.6&pid=1.7',38,'Fruit',10,2),('dzy',15,1,'','https://static.specsonline.com/wp-content/uploads/2020/10/007161093006.jpg',5,'',11,7);
...
insert  into `order`(`id`,`time`,`total_price`,`status`,`restaurant`,`user`) values (1,'2001-10-13 06:58:46',39,'Cancel',2,1),(2,'2022-11-14 14:48:14',39,'Paid',2,1),(3,'2022-11-14 07:17:21',39,'Unpaid',2,1),(4,'2022-11-14 07:26:43',39,'Unpaid',2,1),(5,'1974-04-27 11:19:12',77,'Paid',2,1),(6,'2022-11-14 09:11:53',39,'Unpaid',2,1),(7,'2022-11-18 02:18:32',39,'Cancel',2,1),(8,'2022-12-02 02:28:43',82,'Done',2,19),(9,'2022-12-02 02:28:43',39,'Paid',2,19),(10,'2022-12-02 02:47:34',15,'Paid',7,19),(11,'2022-12-02 02:47:43',15,'Done',7,19),(12,'2022-12-02 02:56:15',15,'Done',7,19),(13,'2022-12-04 21:49:46',30,'Done',7,19),(14,'2022-12-05 09:45:24',45,'Cancel',7,19);
...
insert  into `ordered_food`(`food`,`order`,`quantity`,`id`) values (2,4,1,1),(2,6,1,2),(2,7,1,3),(2,9,1,4),(10,8,2,5),(11,10,1,6),(11,11,1,7),(11,12,1,8),(11,13,2,9),(11,14,3,10);
...
insert  into `restaurant`(`name`,`description`,`location`,`id`,`merchant`) values ('Fruit Shop','Sell all kinds of fresh fruit','New York, USA',2,3),('dingzhen','1!5!','litang',7,23);
...
insert  into `review`(`rating`,`comments`,`restaurant`,`time`,`id`,`user`) values (8,'nulla qui reprehenderit Duis',2,'2013-06-29 07:56:17',1,1),(10,'good one',7,'2022-12-05 04:32:12',3,19);
...
CREATE TABLE `user` (
  ...
  `icon` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT 'The url of Icon',
  `id` int unsigned NOT NULL AUTO_INCREMENT,
